...
%Summarize the tasks
In our project, we learn to deal with the challenges of class imbalanced data-sets and how to overcome them. We will be replicating the work done in \cite{smote} and understand the problem by going over the previous works cited in this paper and summarizing the various techniques researchers came up with regards to dealing with it. Next we overview the performance metrics used by this paper. We explain why the author chose to use these metrics and how are they relevant to this particular problem. We then move on to the implementation of the algorithm SMOTE\cite{smote} proposed in the paper, along with two more approaches which was used to emphasize the novelty of this technique. We will conclude our project with replicating the experiments section on 3 of the 9 data-sets listed in the paper, using C4.5, Ripper and Naíve Bayes classifiers to learn models. We will use the prediction results from these models to plot ROC curves, and taking AUC and convex hull of the curve as evaluation metric, compare our graphs with the graphs obtained in the paper.
